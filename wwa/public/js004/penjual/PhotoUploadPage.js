...
export class PhotoUploadPage {
    ...
    init() {
        ...
        this._view.input.onchange = () => {
            ...
            this.loadImage(this._view.input).then(() => {
                ...
                this._statusUpload = false;
                dialog.tampil('gagal dalam memproses gambar');
            });
        };
    ...
    upload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let hasil = yield Util.AjaxLogin('post', Util.urlFileUpload, this.populateJson());
            if (200 == hasil.status) {
                console.log(hasil);
                return parseInt(JSON.parse(hasil.responseText).baris.insertId);
            }
            else {
