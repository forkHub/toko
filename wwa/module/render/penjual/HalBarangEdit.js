    ...
    render(barang) {
		...
		<html lang="id">
			<head>
				...
				<script>
					var barangData=${JSON.stringify(barang)};					
				</script>
			...
			<body>
				<div class="container">
					...
					<div class='foto-cont'>
						...
						<button type="button" class='btn btn-danger hapus-foto'>hapus</button>
					</div>
					<hr/>
					...
					<form action="">
						...
						<input type="hidden" class='file_id' value="${barang.file_id}">
