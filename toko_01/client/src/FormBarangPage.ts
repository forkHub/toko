...
class FormBarangPage {
	...
	private upload: PhotoUploadPage;
	private _view: FormBarangView = new FormBarangView();
	...
	init(): void {
		...
		this.view.form.onsubmit = (e: Event) => {
			e.stopPropagation();
	...
	objToForm(data: IBarangDBO): void {
	...
	formToObj(publish: number): IBarangDBO {
		return {
	...
	public get view(): FormBarangView {
		return this._view;
	}
